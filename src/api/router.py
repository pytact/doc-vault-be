...
from src.users.superadmin_router import router as superadmin_users_router
...
api_router.include_router(superadmin_users_router)  # SuperAdmin user management endpoints
api_router.include_router(roles_router)
api_router.include_router(taxonomy_router)
api_router.include_router(documents_router)
api_router.include_router(notification_router)
api_router.include_router(dashboard_router)  # Analytics dashboard endpoint
