...
- CORRECT Success: `{"success": true, "data": {...}, "message": "..."}` - Order: `success`, `data`, `message`

**RULE 2.3.2: Error Response Format**
- CORRECT Error: `{"success": false, "error": {"code": "...", "details": [...]}, "message": "..."}` - Order: `success`, `error`, `message` (error has NO message field)

**RULE 2.3.3: Response Format Rules**
- CORRECT Field order is CRITICAL: `success`, `data`/`error`, `message`
...
- CORRECT Action: Wrap all responses in `StandardResponse[T]` with correct field order (success, data, message)
...
- CORRECT Error response format: `{"success": false, "error": {"code": "...", "details": [...]}, "message": "..."}`
- CORRECT `error` object has NO `message` (only `code` and `details`)
- CORRECT `message` is at root level only
- CORRECT Field order is CRITICAL: `success`, `error`, `message` (in this exact order)
